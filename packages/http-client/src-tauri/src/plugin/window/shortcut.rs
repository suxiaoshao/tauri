...
use crate::{app_search, errors::HttpResult};
...
pub fn on_short<R: Runtime>(app: &AppHandle<R>) -> HttpResult<()> {
...
pub fn create_main_window<R: Runtime>(app: &AppHandle<R>) -> HttpResult<()> {
